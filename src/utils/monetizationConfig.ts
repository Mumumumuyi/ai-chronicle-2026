...
export const DEFAULT_PARTNERS: MonetizationPartner[] = [
  // 1. GPU & Compute (Highest earning potential: 10%-15% recurring affiliate cash payout)
  {
    ...
    perkBadgeEn: '10% Referral Rebate',
  ...
  },
  {
    ...
    perkBadgeZh: '新人充值立减 20 元',
    perkBadgeEn: '¥20 CNY Welcome Voucher',
  ...
  },
  {
    ...
    perkBadgeZh: '单卡低至 $0.50/小时',
    perkBadgeEn: 'Starting at $0.50/hr',
  ...
  // 2. Coding Agents & IDEs
  {
    ...
    perkBadgeZh: '首月免费试用 Pro 特权',
    perkBadgeEn: 'Free Pro Trial Available',
  ...
  },
  {
    ...
    perkBadgeZh: '永久免费基础额度',
    perkBadgeEn: 'Generous Free Tier',
  ...
  // 3. Inference Acceleration & Serverless API
  {
    ...
    perkBadgeZh: '免费试用极速 API',
    perkBadgeEn: 'Free High-Speed API Key',
  ...
  },
  {
    ...
    perkBadgeZh: '注册立赠 $5 API 额度',
    perkBadgeEn: '$5 Instant API Credit',
  ...
  // 4. Creative & Multimodal
  {
    ...
    perkBadgeZh: '年付享 20% 专属折扣',
    perkBadgeEn: 'Save 20% on Annual Plans',
  ...
  },
  {
    ...
    perkBadgeZh: '首月 80% 专属抵扣',
    perkBadgeEn: '80% Off First Month',
...
export const DEFAULT_OWNER_CONTACT: OwnerBusinessContact = {
  contactEmail: 'contact@aichronicle.dev',
  wechatId: 'AICronicle_Admin',
  ...
  customNoticeZh: '支持微信 / 支付宝 / PayPal / USDT 结算。合作申请将在 4 小时内由主理人亲自响应。',
};
